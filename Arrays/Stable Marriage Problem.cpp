...
partners. If there are no such people, all the marriages are “stable” (Source Wiki).
...
void stableMarriage(int men_prefer[N][N], women_prefer[N][N]) {
    ...
    unordered_map<int,bool> free_men;
    for (int i = 0; i < N; ++i) free_men[i] = true;
    int women_partner[N];
