...
You have to go n-1 steps right and m-1 steps down, that is sure. However it depends first 
you go 2 steps right than 2 down and than remaining n-3 steps right and m-3 steps down.
