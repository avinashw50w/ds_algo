...
3rd stone, then 2 units to the 4th stone, then 3 units to the 6th stone, 4 units to the 7th stone, and 5 units to the 8th stone.
Example 2:
...
public:
    bool solve(vector<int>& stones, int pos, int jump) {
        ...
        for (int i = pos + 1; i < n; ++i) {
            ...
            if (solve(stones, i, dist)) return m[key] = true;
        }
        return m[key] = false;
    }
